...
print(
    "\x1b[48;5;81m Больше 5 \x1b[0m", 
    "\u001b[48;5;82m Меньше 5 \x1b[0m"
    )
print("")
...
for line in range(min(up5,down5)//4):
    print(
        f"\x1b[48;5;{maxi}m{length}\x1b[0m", 
        f"\x1b[48;5;{mini}m{length}\x1b[0m"
        )
...
print(
    " ", 
    str(round(max(up5,down5)* 100 / sum))+"%", 
    " ", 
    str(round(min(up5,down5)* 100 / sum))+"%"
    )
